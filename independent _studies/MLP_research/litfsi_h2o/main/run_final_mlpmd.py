...
def generate_lammps_input(
    ...
    input_script = os.path.join("../logs", f"{label}.in")  # Save .in file in log_dir
...
thermo          100 # Log thermodynamics every 0.5 ps
restart         20000 {label}.restart

# Dump trajectory for equilibration
dump            1 all custom 100 {eq_pos_file} element xu yu zu
