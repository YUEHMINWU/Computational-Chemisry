...
-> high uncertain frames will be augmented to primary model for training the augmented primary model in next iteration, if the force rmse doesn't be smaller than specific threshold.
